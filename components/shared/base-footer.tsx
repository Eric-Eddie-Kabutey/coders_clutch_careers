        ...
        <ScrollReveal>
            <div className="max-container 2xl:w-[85%] md:w-[95%] w-[95%] mx-auto pt-8 flex justify-between items-center gap-6">
                ...
                <div className="px-6 flex justify-center items-center gap-4">
                    ...
                    {/* Sitemap SVG */}
                    <Link href="https://codersclutch.com/page-sitemap"  
                        target="_blank"
        ...
        <div className='w-full py-6 flex flex-col gap-6 bg-app-primary-deep'>
            <ScrollReveal>
                <div className="w-full hidden sm:flex justify-center items-center gap-4 text-gray-200 text-[14px]">
                    <Link href="https://codersclutch.com/cookie-policy" className="hover:text-white transition-colors">Cookie Policy</Link>
                    <span className=''>|</span>
                    <Link href="https://codersclutch.com/terms-of-use" className="hover:text-white transition-colors">Terms of Use</Link>
                    <span className=''>|</span>
                    <Link href="https://codersclutch.com/privacy-policy" className="hover:text-white transition-colors">Privacy Policy</Link>
                    <span className=''>|</span>
                    <Link href="https://codersclutch.com/ims-policy" className="hover:text-white transition-colors">IMS Policy</Link>
                </div>
            </ScrollReveal>
            <ScrollReveal>
